...
const EditorTab = ({tab} : {tab:IHareEditorEntry}) => {
	...
	const handleClose = (tab:any) => {
		tab.isPreview =false;
		procurator.context.removeFileEdit(tab)
  }
	...
	return (
		<div 
			className={(true) ? "editor-tab-entry editor-tab-entry-selected" : "editor-tab-entry editor-tab-entry-unselected"}
			...
			<svg
				...
				height="16"
				fill="#ffffff"
				className={(true) ? "editor-tab-entry-close" : "editor-tab-entry-close editor-tab-entry-close-hidden"}
				viewBox="0 0 16 16"
